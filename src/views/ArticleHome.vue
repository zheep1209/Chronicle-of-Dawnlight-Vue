...
<!--            撤销-->
            <button :disabled="!editor.can().chain().focus().undo().run()" @click="editor.chain().focus().undo().run()">
              <svg t="1731410793576" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="37677" width="20" height="20"><path d="M396.8 200.533333l64 64L384 341.333333h298.666667c119.466667 0 213.333333 93.866667 213.333333 213.333334s-93.866667 213.333333-213.333333 213.333333H298.666667v-85.333333h384c72.533333 0 128-55.466667 128-128s-55.466667-128-128-128H170.666667l226.133333-226.133334z" fill="#515151" p-id="37678"></path></svg>
            </button>
<!--            返回-->
            <button :disabled="!editor.can().chain().focus().redo().run()" @click="editor.chain().focus().redo().run()">
              <svg t="1731410793576" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="37677" width="20" height="20" style="transform: scaleX(-1);">
                <path d="M396.8 200.533333l64 64L384 341.333333h298.666667c119.466667 0 213.333333 93.866667 213.333333 213.333334s-93.866667 213.333333-213.333333 213.333333H298.666667v-85.333333h384c72.533333 0 128-55.466667 128-128s-55.466667-128-128-128H170.666667l226.133333-226.133334z" fill="#515151" p-id="37678"></path>
              </svg>
...
<!--            一级标题-->
            ...
            <button :class="{ 'is-active': editor.isActive('heading', { level: 3 }) }"
              ...
              <svg class="icon" height="20" p-id="4480" x="1731409780496"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <button :class="{ 'is-active': editor.isActive('heading', { level: 4 }) }"
              ...
              <svg class="icon" height="20" p-id="5613" x="1731409820071"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <button :class="{ 'is-active': editor.isActive('heading', { level: 5 }) }"
              ...
              <svg class="icon" height="20" p-id="6734" x="1731409858034"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            六级标题-->
            <button :class="{ 'is-active': editor.isActive('heading', { level: 6 }) }"
              ...
              <svg class="icon" height="20" p-id="7757" x="1731409891393"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            水平线-->
            <button @click="editor.chain().focus().setHorizontalRule().run()">
              <svg class="icon" height="20" p-id="25466" x="1731410327075"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <button :class="{ 'is-active': editor.isActive('highlight') }"
              ...
              <svg class="icon" height="20" p-id="14893" x="1731409996542"
                    viewBox="0 0 1029 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            靠左-->
            <button :class="{ 'is-active': editor.isActive({ textAlign: 'left' }) }"
              ...
              <svg class="icon" height="20" p-id="18220" x="1731410122141"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            居中-->
            <button :class="{ 'is-active': editor.isActive({ textAlign: 'center' }) }"
              ...
              <svg class="icon" height="20" p-id="17198" x="1731410088369"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            靠右-->
            <button :class="{ 'is-active': editor.isActive({ textAlign: 'right' }) }"
              ...
              <svg class="icon" height="20" p-id="19241" x="1731410156932"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
...
<!--            紫色-->
            <button :class="{ 'is-active': editor.isActive('textStyle', { color: '#958DF1' }) }"
              ...
              <svg class="icon" height="20" p-id="22661" x="1731410268222"
                    viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                <path
